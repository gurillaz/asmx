          ...
          <v-sheet tile color="grey lighten-4">
            <v-container fluid class="py-1">
              <v-row class="pr-2">
                ...
                <v-col cols="auto" v-if="order.created_at !== order.updated_at">
                  <p class="text-info caption pb-0 mb-0">Modifikuar me:</p>
                  <p class="py-0 my-0">
                    {{ moment(order.updated_at).format("DD-MM-YY HH:mm") }}
                  </p>
                </v-col>
          ...
          >
            ...
            <template v-slot:item.quantity="props">
              <v-edit-dialog
                ...
                persistent
                @save="update_product(props.item)"
              >
...
export default {
  ...
  methods: {
    ...
    update_product(product) {
      ...
      axios
        .post("/api/order/update_quantity", data)
        .then((response) => {
          //   console.log(response.data.products);
          this.errors = null;
